...
public class MechaBeastFactory {
    ...
    public static MechaBeast createKyoflare() {
        ...
        beast.addSkill(new Skill("Blaze Fangs", ElementType.FIRE, 65, 80, 50, 2));
    ...
    public static MechaBeast createNokami() {
        ...
        beast.addSkill(new Skill("Aqua Slice", ElementType.WATER, 60, 70, 45, 2));
        beast.addSkill(new Skill("Shuriken Wave", ElementType.WATER, 85, 105, 70, 3));
        return beast;
    }
    ...
    public static MechaBeast createVineratops() {
        ...
        beast.addSkill(new Skill("Horn Vines", ElementType.GRASS, 70, 80, 55, 2));
    ...
    public static MechaBeast createVoltchu() {
        ...
        beast.addSkill(new Skill("Electric Slash", ElementType.ELECTRIC, 65, 75, 50, 2));
    ...
    public static MechaBeast createZyuugor() {
        ...
        beast.addSkill(new Skill("Mineral Bomb", ElementType.EARTH, 75, 85, 60, 2));
    ...
    public static MechaBeast createPirrot() {
        ...
        beast.addSkill(new Skill("Wing Blade", ElementType.WIND, 65, 75, 50, 2));
        beast.addSkill(new Skill("Tempest Slash", ElementType.WIND, 95, 115, 80, 3));
        return beast;
    }
    ...
    public static MechaBeast createGekuma() {
        ...
        beast.addSkill(new Skill("Power Jab", ElementType.FIGHTING, 65, 75, 50, 2));
    ...
    public static MechaBeast createShadefox() {
        ...
        beast.addSkill(new Skill("Crescent Claw", ElementType.DARK, 65, 75, 50, 2));
        beast.addSkill(new Skill("Phantom Slash", ElementType.DARK, 90, 100, 80, 3));
        return beast;
    }
    ...
    public static MechaBeast createKingmantis() {
        ...
        beast.addSkill(new Skill("Twin Dagger", ElementType.STEEL, 90, 100, 55, 2));
    ...
    public static MechaBeast createWisdrake() {
        ...
        beast.addSkill(new Skill("Neuro Pulse", ElementType.PSYCHIC, 65, 82, 55, 2));
